...
<body>
	...
	<div id="formulario">
		...
		<div id="conteudo">
			...
			<br><br>
				<input class="w3-input w3-border" type="text" name="nome" maxlength="30" require autofocus placeholder="Nome">
				<input class="w3-input w3-border" type="text" name="sobrenome" maxlength="50" required placeholder="Sobrenome">
				<input class="w3-input w3-border" type="email" name="email" maxlength="50" required placeholder="E-mail">
				<input class="w3-input w3-border" type="password" name="senha" maxlength="12" required placeholder="Senha">
